...
function App() {
  ...
  return (
    <div className="app">
      <nav id="navbar">
        <img
          src="https://fontmeme.com/permalink/210709/dfedef5feb40a02ad37fdc8703f7d163.png"
          alt="logo-img"
        />
        <div>
          Try{" "}
        ...
        !isLoading ? (
            ...
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Abilities : {detail.abilities[0]},{detail.abilities[1]}
                </p>
                <p className="card-text">
                  Move :{detail.moves[0]},{detail.moves[1]},{detail.moves[2]}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="card" style={{ width: "18rem" }}>
              <img
                className="card-img-top"
                src="https://i.gifer.com/YjKA.gif"
                alt="Card cap"
              />
              <div className="card-body">
          ...
          <div className="container">
            <div className="card" style={{ width: "18rem" }}>
              <img
                className="card-img-top"
                src="https://media.tenor.co/images/60480beaace5b157e498a69027a0d0d7/raw"
                alt="Card cap"
              />
